parcelRequire = function(e, r, t, n) {
    ...
    "epB2": [function(require, module, exports) {
        ...
        var o = function(t, e) {
            ...
            s = (r(t = {}, a.defaultOptions, {
                ...
                return n({}, s, r({}, a.defaultOptions, n({}, this[a.defaultOptions], {}, t)))
                ...
                h.className = u, h.innerHTML = e, i(h, {
                    "data-position": f,
                    "data-state": t
                }), o(h, p);
                var O = 0;
                ...
                f.insertBefore(t, f.firstChild), o(t, (r(n = {
                    position: "body" === i ? "fixed" : "absolute"
                }, u(t, "top") ? "top" : "bottom", "-100px"), r(n, u(t, "left") && "left", "15px"), r(n, u(t, "center") && "left", "".concat(f.clientWidth / 2 - t.clientWidth / 2, "px")), r(n, u(t, "right") && "right", "15px"), n)), o(t, {
                    transform: "scale(1)",
                    opacity: 1
                });
                var l = s;
                Array.from(document.querySelectorAll(".".concat(a, '[data-position="').concat(c(t, "data-position"), '"]'))).filter(function(e) {
                    return e.parentElement === t.parentElement
                }).forEach(function(t) {
                    o(t, r({}, u(t, "top") ? "top" : "bottom", "".concat(l, "px"))), l += t.offsetHeight + s
                })
                ...
                var e, n = this,
                    ...
                    u = s.left,
                    f = s.width;
                o(t, (r(e = {}, i(t, "left") && "left", "".concat(f, "px")), r(e, i(t, "center") && "left", "".concat(u + f, "px")), r(e, i(t, "right") && "right", "-".concat(f, "px")), r(e, "opacity", 0), e));
            ...
            }), r(t, "warn", function(t, e) {
                return this[a.render]("warn", t, e)
            }), t),
            u = s;
        exports.default = u;
    }, {}],
    "nwU6": [function(require, module, exports) {
        ...
        window.siiimpleToast = e.default;
    }, {
        "./main": "epB2"
    }]
}, {}, ["nwU6"], null)